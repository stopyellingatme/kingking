...
const Todos = (0, import_index_0145b198.c)(($$result, $$props, $$bindings, slots) => {
  let { todos } = $$props;
...
<div class="${"todos svelte-dmxqmd"}"><h1>Todos</h1>
	...
	${(0, import_index_0145b198.e)(todos, (todo) => {
    return `<div class="${["todo svelte-dmxqmd", todo.done ? "done" : ""].join(" ").trim()}"><form action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_0145b198.b)("value", todo.uid, 0)} class="${"svelte-dmxqmd"}">
				<input type="${"hidden"}" name="${"done"}"${(0, import_index_0145b198.b)("value", todo.done ? "" : "true", 0)} class="${"svelte-dmxqmd"}">
				<button class="${"toggle svelte-dmxqmd"}" aria-label="${"Mark todo as " + (0, import_index_0145b198.d)(todo.done ? "not done" : "done")}"></button></form>

			<form class="${"text svelte-dmxqmd"}" action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_0145b198.b)("value", todo.uid, 0)} class="${"svelte-dmxqmd"}">
				<input aria-label="${"Edit todo"}" type="${"text"}" name="${"text"}"${(0, import_index_0145b198.b)("value", todo.text, 0)} class="${"svelte-dmxqmd"}">
				<button class="${"save svelte-dmxqmd"}" aria-label="${"Save todo"}"></button></form>

			<form action="${"/todos?_method=DELETE"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_0145b198.b)("value", todo.uid, 0)} class="${"svelte-dmxqmd"}">
